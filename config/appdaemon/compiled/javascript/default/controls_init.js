$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock-clock"] = new baseclock("default-clock-clock", "", "default", {'namespace': 'default', 'entity': 'clock.clock', 'widget_type': 'baseclock', 'static_icons': [], 'css': {}, 'title_is_friendly_name': 1, 'static_css': {'time_style': 'color: #fff;', 'date_style': 'color: #fff;', 'widget_style': 'background-color: rgba(255,255,255,0.2);'}, 'icons': [], 'fields': {'time': '', 'date': ''}})
    
        widgets["default-default"] = new basejavascript("default-default", "", "default", {'skin': 'default', 'namespace': 'default', 'dashboard': 'Controls', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': 'Default', 'title': '样式'}})
    
        widgets["default-blue"] = new basejavascript("default-blue", "", "default", {'skin': 'blue', 'namespace': 'default', 'dashboard': 'Controls', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': 'blue', 'title': '样式'}})
    
        widgets["default-house"] = new basejavascript("default-house", "", "default", {'skin': 'house', 'namespace': 'default', 'dashboard': 'Controls', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': 'house', 'title': '样式'}})
    
        widgets["default-snow"] = new basejavascript("default-snow", "", "default", {'skin': 'snow', 'namespace': 'default', 'dashboard': 'Controls', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': 'snow', 'title': '样式'}})
    
        widgets["default-forest"] = new basejavascript("default-forest", "", "default", {'skin': 'forest', 'namespace': 'default', 'dashboard': 'Controls', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': 'forest', 'title': '样式'}})
    
        widgets["default-metro"] = new basejavascript("default-metro", "", "default", {'skin': 'metro', 'namespace': 'default', 'dashboard': 'Controls', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': 'Metro', 'title': '样式'}})
    
        widgets["default-load-main-panel"] = new basejavascript("default-load-main-panel", "", "default", {'namespace': 'default', 'dashboard': 'MainPanel', 'icon_inactive': 'fa-home', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-home'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '总控开关'}})
    
        widgets["default-load-living-room-panel"] = new basejavascript("default-load-living-room-panel", "", "default", {'namespace': 'default', 'dashboard': 'LivingRoomPanel', 'icon_inactive': 'fa-play', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-play'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '播放控制'}})
    
        widgets["default-load-dinner-panel"] = new basejavascript("default-load-dinner-panel", "", "default", {'namespace': 'default', 'dashboard': 'Dinner', 'icon_inactive': 'mdi-projector', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'mdi-projector'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '投影机'}})
    
        widgets["default-load-bathroom-panel"] = new basejavascript("default-load-bathroom-panel", "", "default", {'namespace': 'default', 'dashboard': 'Bathroom', 'icon_inactive': 'fa-laptop', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-laptop'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '电脑'}})
    
        widgets["default-load-bedroom2-panel"] = new basejavascript("default-load-bedroom2-panel", "", "default", {'namespace': 'default', 'dashboard': 'Bedroom2', 'icon_inactive': 'mdi-lightbulb-outline', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'mdi-lightbulb-outline'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '灯光'}})
    
        widgets["default-load-controls"] = new basejavascript("default-load-controls", "", "default", {'namespace': 'default', 'dashboard': 'Controls', 'icon_inactive': 'fa-dashboard', 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-dashboard'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '主题设置'}})
    
        widgets["default-reload"] = new basejavascript("default-reload", "", "default", {'namespace': 'default', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'static_icons': [], 'static_css': {'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(255,255,255,0.2);', 'title_style': 'color: #fff;font-weight: 400;'}, 'widget_type': 'basejavascript', 'fields': {'icon_style': '', 'icon': '', 'title2': '', 'title': '重新加载'}, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-refresh'}, 'command': 'location.reload(true)'})
