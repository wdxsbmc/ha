$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-default"] = new basejavascript("default-default", "", "blue", {'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'dashboard': 'Controls', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'namespace': 'default', 'static_icons': [], 'fields': {'icon_style': '', 'title': '样式', 'icon': '', 'title2': 'Default'}, 'skin': 'default'})
    
        widgets["default-blue"] = new basejavascript("default-blue", "", "blue", {'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'dashboard': 'Controls', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'namespace': 'default', 'static_icons': [], 'fields': {'icon_style': '', 'title': '样式', 'icon': '', 'title2': 'blue'}, 'skin': 'blue'})
    
        widgets["default-house"] = new basejavascript("default-house", "", "blue", {'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'dashboard': 'Controls', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'namespace': 'default', 'static_icons': [], 'fields': {'icon_style': '', 'title': '样式', 'icon': '', 'title2': 'house'}, 'skin': 'house'})
    
        widgets["default-snow"] = new basejavascript("default-snow", "", "blue", {'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'dashboard': 'Controls', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'namespace': 'default', 'static_icons': [], 'fields': {'icon_style': '', 'title': '样式', 'icon': '', 'title2': 'snow'}, 'skin': 'snow'})
    
        widgets["default-forest"] = new basejavascript("default-forest", "", "blue", {'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'dashboard': 'Controls', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'namespace': 'default', 'static_icons': [], 'fields': {'icon_style': '', 'title': '样式', 'icon': '', 'title2': 'forest'}, 'skin': 'forest'})
    
        widgets["default-metro"] = new basejavascript("default-metro", "", "blue", {'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'basejavascript', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-gear'}, 'dashboard': 'Controls', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'namespace': 'default', 'static_icons': [], 'fields': {'icon_style': '', 'title': '样式', 'icon': '', 'title2': 'Metro'}, 'skin': 'metro'})
