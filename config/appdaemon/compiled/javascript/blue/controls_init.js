$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock-clock"] = new baseclock("default-clock-clock", "", "blue", {'static_css': {'time_style': 'color: #fff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);', 'date_style': 'color: #fff;'}, 'widget_type': 'baseclock', 'title_is_friendly_name': 1, 'fields': {'date': '', 'time': ''}, 'namespace': 'default', 'icons': [], 'static_icons': [], 'entity': 'clock.clock', 'css': {}})
    
        widgets["default-default"] = new basejavascript("default-default", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'skin': 'default', 'fields': {'title2': 'Default', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-blue"] = new basejavascript("default-blue", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'skin': 'blue', 'fields': {'title2': 'blue', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-house"] = new basejavascript("default-house", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'skin': 'house', 'fields': {'title2': 'house', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-snow"] = new basejavascript("default-snow", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'skin': 'snow', 'fields': {'title2': 'snow', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-forest"] = new basejavascript("default-forest", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'skin': 'forest', 'fields': {'title2': 'forest', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-metro"] = new basejavascript("default-metro", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'skin': 'metro', 'fields': {'title2': 'Metro', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-load-main-panel"] = new basejavascript("default-load-main-panel", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '总控开关', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-home', 'dashboard': 'MainPanel', 'static_icons': [], 'icons': {'icon_inactive': 'fa-home', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-load-living-room-panel"] = new basejavascript("default-load-living-room-panel", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '播放控制', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-play', 'dashboard': 'LivingRoomPanel', 'static_icons': [], 'icons': {'icon_inactive': 'fa-play', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-load-dinner-panel"] = new basejavascript("default-load-dinner-panel", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '投影机', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'mdi-projector', 'dashboard': 'Dinner', 'static_icons': [], 'icons': {'icon_inactive': 'mdi-projector', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-load-bathroom-panel"] = new basejavascript("default-load-bathroom-panel", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '电脑', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-laptop', 'dashboard': 'Bathroom', 'static_icons': [], 'icons': {'icon_inactive': 'fa-laptop', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-load-bedroom2-panel"] = new basejavascript("default-load-bedroom2-panel", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '灯光', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'mdi-lightbulb-outline', 'dashboard': 'Bedroom2', 'static_icons': [], 'icons': {'icon_inactive': 'mdi-lightbulb-outline', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-load-controls"] = new basejavascript("default-load-controls", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '主题设置', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-dashboard', 'dashboard': 'Controls', 'static_icons': [], 'icons': {'icon_inactive': 'fa-dashboard', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-reload"] = new basejavascript("default-reload", "", "blue", {'static_css': {'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '重新加载', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'command': 'location.reload(true)', 'static_icons': [], 'icons': {'icon_inactive': 'fa-refresh', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
