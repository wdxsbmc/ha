$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-light-wgd"] = new baselight("default-light-wgd", "", "metro", {'icon_on': 'mdi-white-balance-incandescent', 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.gateway_light_7c49eb1cf7d1'}, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'css': {'icon_style_inactive': 'color: #ffffff;', 'icon_style_active': 'color: #fff176;animation: rotate2 2s 1;'}, 'widget_type': 'baselight', 'icon_off': 'mdi-white-balance-incandescent', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.gateway_light_7c49eb1cf7d1'}, 'namespace': 'default', 'entity': 'light.gateway_light_7c49eb1cf7d1', 'static_css': {'level_up_style': 'color: #ffffff;', 'state_text_style': 'color: #ffffff;', 'title2_style': 'color: #ffffff;', 'widget_style': 'background-color: rgba(206, 62, 51, 0.85);', 'level_down_style': 'color: #ffffff;', 'unit_style': 'color: #eeeeee;', 'level_style': 'color: #eeeeee;', 'title_style': 'color: #ffffff;'}, 'fields': {'icon_style': '', 'state_text': '', 'level': '', 'title': '网关灯', 'units': '%', 'icon': '', 'title2': ''}, 'icons': {'icon_on': 'mdi-white-balance-incandescent', 'icon_off': 'mdi-white-balance-incandescent'}})
    
        widgets["default-light-bgs"] = new baseswitch("default-light-bgs", "", "metro", {'icon_on': 'mdi-white-balance-incandescent', 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.wall_switch_158d00016d99cc'}, 'static_icons': [], 'css': {'icon_style_inactive': 'color: #ffffff;', 'icon_style_active': 'color: #fff176;animation: rotate2 2s 1;'}, 'widget_type': 'baseswitch', 'entity': 'switch.wall_switch_158d00016d99cc', 'state_inactive': 'off', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.wall_switch_158d00016d99cc'}, 'namespace': 'default', 'enable': 1, 'state_active': 'on', 'static_css': {'state_text_style': 'color: #ffffff;', 'title2_style': 'color: #ffffff;', 'widget_style': 'background-color: rgba(82, 170, 236, 0.85);', 'title_style': 'color: #ffffff;'}, 'icon_off': 'mdi-white-balance-incandescent', 'fields': {'icon_style': '', 'state_text': '', 'icon': '', 'title2': '', 'title': '办公室灯'}, 'icons': {'icon_on': 'mdi-white-balance-incandescent', 'icon_off': 'mdi-white-balance-incandescent'}})
    
        widgets["default-label-test"] = new basedisplay("default-label-test", "", "metro", {'namespace': 'default', 'static_icons': [], 'static_css': {'state_text_style': '', 'title2_style': 'color: #ffffff;', 'container_style': '', 'widget_style': 'background-color: rgba(205, 220, 57, 0.85);', 'value_style': 'color: #ffffff;', 'unit_style': '', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basedisplay', 'fields': {'title2': '', 'state_text': '', 'value': 'hello test', 'title': '', 'unit': ''}, 'css': {}, 'icons': []})
