$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock-clock"] = new baseclock("default-clock-clock", "", "metro", {'static_css': {'time_style': 'color: #ffffff;', 'widget_style': 'background-color: rgba(233, 30, 99, 0.85);', 'date_style': 'color: #ffffff;'}, 'widget_type': 'baseclock', 'title_is_friendly_name': 1, 'fields': {'date': '', 'time': ''}, 'namespace': 'default', 'icons': [], 'static_icons': [], 'entity': 'clock.clock', 'css': {}})
    
        widgets["default-default"] = new basejavascript("default-default", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'skin': 'default', 'fields': {'title2': 'Default', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-blue"] = new basejavascript("default-blue", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'skin': 'blue', 'fields': {'title2': 'blue', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-house"] = new basejavascript("default-house", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'skin': 'house', 'fields': {'title2': 'house', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-snow"] = new basejavascript("default-snow", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'skin': 'snow', 'fields': {'title2': 'snow', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-forest"] = new basejavascript("default-forest", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'skin': 'forest', 'fields': {'title2': 'forest', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-metro"] = new basejavascript("default-metro", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'skin': 'metro', 'fields': {'title2': 'Metro', 'title': '样式', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'dashboard': 'Controls', 'widget_type': 'basejavascript', 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'static_icons': []})
    
        widgets["default-load-main-panel"] = new basejavascript("default-load-main-panel", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '总控开关', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-home', 'dashboard': 'MainPanel', 'static_icons': [], 'icons': {'icon_inactive': 'fa-home', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}})
    
        widgets["default-load-living-room-panel"] = new basejavascript("default-load-living-room-panel", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '播放控制', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-play', 'dashboard': 'LivingRoomPanel', 'static_icons': [], 'icons': {'icon_inactive': 'fa-play', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}})
    
        widgets["default-load-dinner-panel"] = new basejavascript("default-load-dinner-panel", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '投影机', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'mdi-projector', 'dashboard': 'Dinner', 'static_icons': [], 'icons': {'icon_inactive': 'mdi-projector', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}})
    
        widgets["default-load-bathroom-panel"] = new basejavascript("default-load-bathroom-panel", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '电脑', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-laptop', 'dashboard': 'Bathroom', 'static_icons': [], 'icons': {'icon_inactive': 'fa-laptop', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}})
    
        widgets["default-load-bedroom2-panel"] = new basejavascript("default-load-bedroom2-panel", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '灯光', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'mdi-lightbulb-outline', 'dashboard': 'Bedroom2', 'static_icons': [], 'icons': {'icon_inactive': 'mdi-lightbulb-outline', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}})
    
        widgets["default-load-controls"] = new basejavascript("default-load-controls", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '主题设置', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'icon_inactive': 'fa-dashboard', 'dashboard': 'Controls', 'static_icons': [], 'icons': {'icon_inactive': 'fa-dashboard', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}})
    
        widgets["default-reload"] = new basejavascript("default-reload", "", "metro", {'static_css': {'widget_style': 'background-color: rgba(255, 255, 255, 0.05);', 'title2_style': 'color: #ffffff;', 'title_style': 'color: #ffffff;'}, 'widget_type': 'basejavascript', 'fields': {'title2': '', 'title': '重新加载', 'icon_style': '', 'icon': ''}, 'namespace': 'default', 'command': 'location.reload(true)', 'static_icons': [], 'icons': {'icon_inactive': 'fa-refresh', 'icon_active': 'fa-spinner fa-spin'}, 'css': {'icon_active_style': 'color: #ffffff;', 'icon_inactive_style': 'color: #ffffff;'}})
